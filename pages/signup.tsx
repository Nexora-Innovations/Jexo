			...
			<Slider activeSlide={selectedSlide}>
				<div>
					...
					<p className="text-md text-gray-500 dark:text-gray-200">
						Create a new account for this group's Jex
					</p>
				...
				<div>
					<p className="font-bold text-2xl" id="2">
						Make your Jex account
					</p>
					<p className="text-md text-gray-500 dark:text-gray-200">
						You need to create a Jex account to continue
					</p>
					...
					<div className="w-full flex">
						<a className="pt-4 mx-auto  text-gray-400 hover:underline cursor-pointer hover:text-blue-600 transition " href="https://Jexblox.xyz"> © Jex 2022 </a>
					</div>
				</div>
				<div>
					<p className="font-bold text-2xl" id="2">
